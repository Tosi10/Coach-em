...
const mockExercises: Exercise[] = [
  ...
  { id: '4', name: 'Leg Press', description: 'Exercício para pernas realizado em máquina.', difficulty: 'beginner', muscleGroups: ['pernas', 'glúteos'], createdBy: 'coach1', isGlobal: true, createdAt: new Date(), updatedAt: new Date() },
  { id: '5', name: 'Rosca Direta', description: 'Exercício isolado para bíceps.', difficulty: 'beginner', muscleGroups: ['bíceps'], createdBy: 'coach1', isGlobal: true, createdAt: new Date(), updatedAt: new Date() },
  { id: '6', name: 'Tríceps Pulley', description: 'Exercício isolado para tríceps.', difficulty: 'beginner', muscleGroups: ['tríceps'], createdBy: 'coach1', isGlobal: true, createdAt: new Date(), updatedAt: new Date() },
  { id: '7', name: 'Desenvolvimento com Halteres', description: 'Exercício para ombros.', difficulty: 'intermediate', muscleGroups: ['ombros'], createdBy: 'coach1', isGlobal: true, createdAt: new Date(), updatedAt: new Date() },
  { id: '8', name: 'Remada Curvada', description: 'Exercício para costas e bíceps.', difficulty: 'advanced', muscleGroups: ['costas', 'bíceps'], createdBy: 'coach1', isGlobal: true, createdAt: new Date(), updatedAt: new Date() },
  { id: '9', name: 'Abdominal Crunch', description: 'Fortalecimento do core.', difficulty: 'beginner', muscleGroups: ['core', 'abdômen'], createdBy: 'coach1', isGlobal: true, createdAt: new Date(), updatedAt: new Date() },
  { id: '10', name: 'Prancha', description: 'Exercício isométrico para core.', difficulty: 'intermediate', muscleGroups: ['core', 'abdômen'], createdBy: 'coach1', isGlobal: true, createdAt: new Date(), updatedAt: new Date() },
...
export default function EditAssignedWorkoutScreen() {
  ...
  const loadAllExercises = useCallback(async () => {
    try {
      ...
      setAllExercises([...mockExercises, ...saved]);
    } catch (error) {
